import React from 'react';
  ...
  const ThreeBHK: React.FC = () => {
    const threeBHK = PROPERTIES.filter(property => property.type === '3BHK');
    ...
    return (
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          {threeBHK.length === 0 ? (
            <p className="text-center text-gray-600">No 3BHK Apartments available at the moment.</p>
          ) : (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {threeBHK.map(property => (
