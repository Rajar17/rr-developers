import React from 'react';
  ...
  const DuplexVillas: React.FC = () => {
    const duplexVillas = PROPERTIES.filter(property => property.type === 'Duplex Villa');
    ...
    return (
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          {duplexVillas.length === 0 ? (
            <p className="text-center text-gray-600">No Duplex Villas available at the moment.</p>
          ) : (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {duplexVillas.map(property => (
