import React from 'react';
  ...
  const DuplexHouses: React.FC = () => {
    const duplexHouses = PROPERTIES.filter(property => property.type === 'Duplex House');
    ...
    return (
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          {duplexHouses.length === 0 ? (
            <p className="text-center text-gray-600">No Duplex Houses available at the moment.</p>
          ) : (
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {duplexHouses.map(property => (
