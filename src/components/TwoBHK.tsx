import React from 'react';
  ...
  const TwoBHK: React.FC = () => {
    const twoBHK = PROPERTIES.filter(property => property.type === '2BHK');
    ...
    return (
      <section className="py-12 bg-gray-100">
        <div className="container mx-auto px-4">
          ...
          {twoBHK.length === 0 ? (
            <p className="text-center text-gray-600">No 2BHK Apartments available at the moment.</p>
          ) : (
